...
let usertoken = "NzA1ODk2NTg2NDcxMDE0NDYw.X2rXeQ.DXMzpTw4Op7aW0pjlGA4nCL-5l8"; //Token to your virtual account
let from = ["751447115548590101"];
let destination = ["758194330586054686"];
...
user.on("ready", ready => {
  const bot = new Discord.Client();
  bot.login(botstoken)
  console.log("Monitoring Phantom Checkout Log!");
